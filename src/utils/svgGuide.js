    ...
    switch (command.code) {
        ...
        case 'C':
            return <React.Fragment>
                ...
                <circle cx={command.x0} cy={command.y0} strokeWidth="1" opacity="0.7" stroke={terminalStroke} fill={terminalFill} r="8px" />
                <circle cx={command.x} cy={command.y} strokeWidth="1" opacity="0.7" stroke={terminalStroke} fill={terminalFill} r="8px" />
                <circle cx={command.x1} cy={command.y1} strokeWidth="1" opacity="0.7" stroke={controlStroke} fill={controlFill} r="8px" />
                <circle cx={command.x2} cy={command.y2} strokeWidth="1" opacity="0.7" stroke={controlStroke} fill={controlFill} r="8px" />
            </React.Fragment>;
        case 'S':
            return <React.Fragment>
