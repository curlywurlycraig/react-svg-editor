    ...
    switch (command.code) {
        ...
        case 'C':
            return <React.Fragment>
                ...
                <circle className={styles.terminal_point} cx={command.x1} cy={command.y1} strokeWidth="1" stroke={controlStroke} fill={controlFill} r="8px" />
                <circle className={styles.terminal_point} cx={command.x2} cy={command.y2} strokeWidth="1" stroke={controlStroke} fill={controlFill} r="8px" />
            </React.Fragment>;
        case 'S':
            return <React.Fragment>
